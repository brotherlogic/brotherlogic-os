...
2. If we're on the main branch, then create and switch to a new branch with a short, descriptive name: `git checkout -b <descriptive-branch-name>`; otherwise use the existing branch 
